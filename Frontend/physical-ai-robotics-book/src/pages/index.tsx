        ...
        <div className={styles.heroGrid}>
          ...
          <div className={styles.heroBadge}>
            ...
            <div className={styles.heroBadgeText}>
              ...
              <p>Iqra Rehmat Ali · AI Native Developer</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <section className={styles.authorSection}>
      <div className="container">
        <div className={styles.authorCard}>
          <img src={useBaseUrl('/img/author-najaf-ali.svg')} alt="Portrait illustration of Iqra Rehmat Ali" />
          <div>
            <p className={styles.authorLabel}>Author</p>
            <p className={styles.authorName}>Iqra Rehmat Ali</p>
            <p className={styles.authorTitle}>AI Native Developer</p>
            <p className={styles.authorText}>
              Iqra creates AI-native learning experiences that connect simulation,
